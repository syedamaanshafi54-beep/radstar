...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  useEffect(() => {
    ...
    setUserAuthState({ user: null, claims: null, isUserLoading: true, userError: null }); // Reset on auth instance change
      ...
      async (firebaseUser) => {
        if (firebaseUser) {
          try {
            ...
            console.error("FirebaseProvider: Error getting claims:", error);
            setUserAuthState({
              user: firebaseUser,
              claims: null,
              isUserLoading: false,
